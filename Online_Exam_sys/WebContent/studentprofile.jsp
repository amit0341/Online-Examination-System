...
active
     ...
     ">
						<div class="span10">
							<center>
								<img src="assets/img/back.png" alt="Online Exam System"
									height="300px" width="400px" />
							</center>
							<p
								style="font-weight: bold; font-size: 20px; color: black; line-height: 25px;">
								<bold style="color:red;">On-line Exam System</bold>
								is very useful for Educational Institute to prepare an exam,
								safe the time that will take to check the paper and prepare mark
								sheets. It will help the Institute to testing of students and
								develop their skills. But the disadvantages for this system, it
								takes a lot of times when you prepare the exam at the first time
								for usage. And we are needs number of computers with the same
								number of students.
							</p>
							<p
								style="font-weight: bold; font-size: 20px; color: black; line-height: 25px;">
								The effective use of "Online Examination System", any
								Educational Institute or training centers can be use it to
								develop their strategy for putting the exams, and for getting
											...
											<div class="controls">
												...
												<c:if test='${not empty param["Unavailable"]}'>
													<p style='font-weight: bold; color: green'>Result will
														be available after contest ends.</p>
												</c:if>

												<c:if test='${not empty param["NotGiven"]}'>
													<p style='font-weight: bold; color: red'>You have not
														given this Exam.</p>
												</c:if>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<c:if test='${not empty param["alreadygiven"]}'>
													<p style='font-weight: bold; color: red'>You have
														already Given this Paper..</p>
												</c:if>
